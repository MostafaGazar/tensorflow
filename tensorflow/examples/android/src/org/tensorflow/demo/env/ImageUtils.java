...
public class ImageUtils {
    ...
    public static void drawResizedBitmap(final Bitmap src, final Bitmap dst, final Integer sensorOrientation) {
     ...
     */
    public static Uri saveBitmap(final Bitmap bitmap) {
        final String root =
        ...
        return new Uri.Builder().appendEncodedPath(root + fname).build();
    }
